  ...
  Future<void> _handleSubmitted() async {
    ...
    if (!form.validate()) {
      ...
      form.save();
        ...
        final names = fullName.contains(" ")? fullName.split(" "): [fullName, " "];
        final user = Registration(username, firstName: names[0], lastName: names[1] ?? " ", email: email, password: password);
